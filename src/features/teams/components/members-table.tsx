          ...
          {[
            ...
            (
              ...
              <TableRow key={i}>
                {/* Member Name */}
                <TableItem>
                  <Image src='/assets/profile.png' alt={name} width={32} height={32} className="w-8 rounded-full" />
                  <div>
                ...
                {/* Document */}
                <TableItem>
                  <Image src="/assets/icons/pdfIcon.svg" alt="pdf" width={32} height={32} />
                  <div>
                ...
                <TableItem className="justify-between w-[180px]">
                  ...
                  <button className="hover:bg-gray-100 dark:hover:bg-gray-700 p-1 rounded-md transition">
                    <Image src="/assets/icons/more.svg" width={18} height={18} alt="options" />
                  </button>
                </TableItem>
              </TableRow>
            )
