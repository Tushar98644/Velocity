        ...
        <div className='flex flex-col h-full justify-between'>
          ...
          <div>
            <div className='text-gray-500 dark:text-gray-400 text-xs font-medium md:px-2'>
              <button className={`flex ${pathname === '/dashboard/settings' ? 'text-primary' : ''}
                hover:px-8 duration-200 px-6 py-2 items-center gap-2`}>
                <Setting2 size={16} />
                Settings
              </button>

              <button className={`flex ${pathname === '/dashboard/support' ? 'text-primary' : ''}
                hover:px-8 duration-200 px-6 py-2 items-center gap-2`}>
                <Headphone size={16} />
                Support
              </button>
              ...
              {isSignedIn && (
                <div className='flex items-center gap-2'>
                  ...
                  <div>
                    ...
                    <p className='text-xs font-medium text-gray-500 dark:text-gray-400'>{user?.emailAddresses[0].emailAddress}</p>
                  </div>
                </div>
              )}
            </div>
